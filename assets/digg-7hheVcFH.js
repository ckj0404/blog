import{l as n,m as l,a3 as p,p as t}from"./index-D8SmyRDO.js";const e={class:"markdown-body"},i={},j="",u=n({__name:"digg",setup(c,{expose:a}){return a({frontmatter:{},excerpt:void 0}),(r,s)=>(t(),l("div",e,s[0]||(s[0]=[p(`<h2>点赞组件</h2><h2>digg-list</h2><pre><code class="language-vue">&lt;<span class="hljs-name">template</span>&gt;
